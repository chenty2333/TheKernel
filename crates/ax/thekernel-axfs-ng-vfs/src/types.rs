...
/// Provider-backed optional metadata. Absence means the provider makes no
/// claim; a timestamp value of zero alone is not evidence of support.
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
pub struct MetadataCapabilities {
    pub birth_time: bool,
    pub direct_io_alignment: Option<DirectIoAlignment>,
}

/// Alignment actually enforced by this node's direct-I/O implementation.
