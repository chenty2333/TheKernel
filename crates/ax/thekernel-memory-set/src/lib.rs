...
pub use self::{
    ...
    set::{
        CommittedFixedReplacement, CommittedMetadataUpdate, FixedReplacementRetirement,
        FixedReplacementRollbackRetirement, MemorySet, MetadataUpdateError,
        PreparedFixedReplacement, PreparedMetadataUpdate, UnmapRetirement,
    },
};
