...
use crate::{
    ...
    queue::VirtQueue,
    transport::Transport,
    volatile::{volread, ReadOnly, WriteOnly},
    Result, PAGE_SIZE,
};
...
///
/// ```
/// # use thekernel_virtio_drivers::{Error, Hal, transport::Transport};
/// use thekernel_virtio_drivers::device::console::VirtIOConsole;
