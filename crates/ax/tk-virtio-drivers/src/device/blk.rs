...
///
/// ```
/// # use tk_virtio_drivers::{Error, Hal};
/// # use tk_virtio_drivers::transport::Transport;
/// use tk_virtio_drivers::device::blk::{SECTOR_SIZE, VirtIOBlk};
///
...
impl<H: Hal, T: Transport> VirtIOBlk<H, T> {
    ...
    /// ```
    /// # use tk_virtio_drivers::{Error, Hal};
    /// # use tk_virtio_drivers::device::blk::VirtIOBlk;
    /// # use tk_virtio_drivers::transport::Transport;
    /// use tk_virtio_drivers::device::blk::{BlkReq, BlkResp, RespStatus};
    ///
