...
use crate::{
    Instruction, LoadWidth, MAX_INSTRUCTIONS, SCRATCH_WORDS, opcode,
    translate::{ImageValidationError, InputProfile, MAX_CODE_IMAGE_BYTES},
};
...
///
/// This is intentionally a separate API from [`crate::CodeImage::validate`]
