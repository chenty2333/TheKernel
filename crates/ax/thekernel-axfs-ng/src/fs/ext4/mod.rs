...
use lwext4_rust::{
    ...
    PhysicalIoPublication, PhysicalIoSegment, PhysicalIoSgOutcome, ffi::EIO,
};
...
/// effect.
fn physical_batch_not_submitted_reason(error: &DevError) -> Option<PhysicalIoNotSubmittedReason> {
    match error {
