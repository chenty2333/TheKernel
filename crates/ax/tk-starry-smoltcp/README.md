...
_smoltcp_ can run without heap allocation and is [extensively documented][docs].
This maintained workspace fork follows the same compiler pin as the other
TheKernel components. The crate uses the root-pinned `nightly-2026-08-23` toolchain
