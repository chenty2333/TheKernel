...
MAINTAINED_SIBLING_PATCHES = {
    ...
    "thekernel-axrcu": ("../thekernel-ax/crates/thekernel-axrcu", "0.1.0"),
...
MAINTAINED_SIBLING_REPO_PATHS = {
    ...
    "thekernel-axrcu": ("ax", Path("crates/thekernel-axrcu")),
