...
CONTRACTS.update({
    "gettimeofday": ("raw-differential", "pass", "READ_BRACKETS_CLOCK_REALTIME NULL_ARGUMENTS_ACCEPTED TIMEZONE_ROUND_TRIP MONOTONIC_RAW_SHARES_MONOTONIC_OFFSET TIMEZONE_EFAULT"),
...
PROGRAM_CASES = {
    ...
    "futex-abi": ("futex-abi-opcode", "futex-abi-wake-zero", "futex-abi-requeue", "futex-abi-pi-word", "futex-abi-pi-timeout", "futex-abi-waitv-numa", "futex-abi-requeue-pi-signal", "futex-abi-pi-signal", "futex-abi-futex2-flags", "futex-abi-requeue-pi"),
