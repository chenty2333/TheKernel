...
PROGRAM_CASES = {
    ...
    "wait-abi": ("wait4", "waitid", "sched_rr_get_interval", "sched_attr", "mempolicy", "sched_query", "setpriority", "ioprio", "ptrace_stop"),
...
SYSCALL_CASES = {
    ...
    111: ("identity", "identity-pgid"), 319: ("memfd-create", "memfd-create"), 121: ("identity", "identity-pgid"), 112: ("identity", "identity-pgid"), 124: ("identity", "identity-pgid"),
