...
CONTRACTS.update({
    "socket_msg.send_flags": ("raw-differential", "pass", "DONTROUTE_SENDTO CONFIRM_SENDTO COMBINED_SENDTO CONFIRM_SENDMSG DONTROUTE_SENDMSG EOR_SENDTO ZEROCOPY_SENDTO UNDEFINED_FLAG_SENDMSG FLAGGED_DATAGRAMS_DELIVERED"),
...
CONTRACTS.update({
    "socket_msg.sendmmsg_flags": ("raw-differential", "pass", "SENDMMSG_TWO SENDMMSG_TWO_RECORDS SENDMMSG_EOR SENDMMSG_EOR_RECORD SENDMMSG_UNDEFINED_FLAG SENDMMSG_UNDEFINED_RECORD SENDMMSG_HEADER_FLAGS_IGNORED SENDMMSG_MORE_CORKS SENDMMSG_MORE_PENDING SENDMMSG_MORE_FLUSH SENDMMSG_MORE_MERGED"),
    ...
    "socket_name_record": ("portable-differential", "pass", "GETSOCKNAME_UNBOUND_ZERO NAME_BIND GETSOCKNAME_BOUND_PORT GETPEERNAME_UNCONNECTED_ENOTCONN GETSOCKNAME_BADLEN_EFAULT GETSOCKNAME_LENGTH_BEFORE_FAULT RECVFROM_NAME_SOCKET RECVFROM_LENGTH_BEFORE_FAULT AUTOBIND_NAME_BIND UNIX_AUTOBIND_NAME_RECORD"),
