...
CONTRACTS.update({
    ...
    "xattr-classic": ("raw-differential", "pass", "SET_GET_CREATE_REPLACE_RULES FD_AND_PATH_VARIANTS_AGREE REMOVE_AND_EMPTY_LIST FIFO_AND_SYMLINK_NAMESPACE_RULES"),
...
CONTRACTS.update({
    "socket_msg.send_flags": ("raw-differential", "pass", "DONTROUTE_SENDTO CONFIRM_SENDTO COMBINED_SENDTO CONFIRM_SENDMSG DONTROUTE_SENDMSG EOR_SENDTO ZEROCOPY_SENDTO UNDEFINED_FLAG_SENDMSG FLAGGED_DATAGRAMS_DELIVERED OOB_SENDTO_STREAM_BYTES OOB_SENDMSG_STREAM_BYTES OOB_SENDTO_DATAGRAM_EOPNOTSUPP OOB_SENDTO_UNIX_STREAM_BYTES OOB_RECV_STREAM_EINVAL OOB_RECVMSG_STREAM_EINVAL OOB_RECV_DATAGRAM_IGNORED OOB_RECV_UNIX_DATAGRAM_EOPNOTSUPP OOB_RECV_UNIX_STREAM_EINVAL OOB_RECV_NETLINK_EOPNOTSUPP"),
    ...
    "clone3": ("raw-differential", "pass", "FLAG_ADMISSION NEWTIME AUTOREAP EMPTY_MNTNS"),
    ...
    "fcntl": ("raw-differential", "pass", "SETFL_IGNORES_OUTSIDE_MASK SETFL_NONBLOCK_ROUNDTRIP SETFL_APPEND_ROUNDTRIP SETFL_ODIRECT_REGULAR SETFL_NOATIME_OWNER SETFL_NOATIME_NONOWNER_EPERM SETFL_NOATIME_ANONYMOUS_OWNER FIFO_OPEN_ODIRECT_EINVAL FIFO_OPEN_ODIRECT_WAITS_THEN_EINVAL FIFO_PACKET_BOUNDARY PACKET_WRITE_MERGES_STREAM_TAIL SETFL_ODIRECT_CLEARED_MERGES SETFL_ODIRECT_FIFO SETFL_ODIRECT_PACKETIZES SETFL_ODIRECT_PIPE"),
    "syslog": ("raw-differential", "pass", "NULL_BUF_EINVAL NEGATIVE_LEN_EINVAL ZERO_LEN_NOOP BAD_PTR_EFAULT UNKNOWN_ACTION_EINVAL CONSOLE_LEVEL_EINVAL SIZE_BUFFER_POSITIVE PERMISSION_BEFORE_VALIDATION_EPERM NULL_BUF_EINVAL_ALL_SELECTORS NEGATIVE_LEN_EINVAL_ALL_SELECTORS"),
    ...
    "fs-path": ("raw-differential", "pass", "OPEN_CREATE_EXCLUSIVE DIRECTORY_WALK PIPE_PAIR LINK_AND_SYMLINK RENAME_RULES MODE_AND_OWNER MKNOD_TYPES DIRECTORY_NAVIGATION PATHNAME_ONLY_FORMS"),
    "fs-basic": ("raw-differential", "pass", "DESCRIPTOR_IO_AND_SEEK POSITIONED_IO VECTORED_IO_BOUNDS DESCRIPTOR_DUPLICATION TRUNCATE_AND_SYNC NON_SEEKABLE_AND_ADVICE_BOUNDS"),
    ...
    "pidfd-send-signal": ("raw-differential", "pass", "FLAGS_BEFORE_FD_EINVAL MULTIPLE_SCOPE_EINVAL BAD_FD_EBADF SELF_THREAD_PROBE SIGNO_MISMATCH_EINVAL FD_BEFORE_SIGNO PROCESS_GROUP_PROBE_OK PROCESS_GROUP_DELIVERS_SIGUSR1 PROCESS_GROUP_ZOMBIE_LEADER_OK PROCESS_GROUP_REAPED_ESRCH PROCESS_GROUP_ABSENT_ESRCH PROCESS_GROUP_SELF_THREAD_OK"),
})
CONTRACTS.update({
    ...
    "socket_netlink_policy": ("portable-differential", "pass", "USERSOCK_PEER_ALLOWED ROUTE_PEER_POLICY REFUSAL_TARGET_BIND REFUSAL_TARGET_CONNECT REFUSAL_SENDER_BIND NETLINK_CONNECT_REFUSES_OTHER_SENDER REFUSAL_PEER_BIND NETLINK_CONNECT_ACCEPTS_PEER NETLINK_CONNECT_PEER_DELIVERED USERSOCK_GROUP_POLICY ROUTE_GROUP_ALLOWED GROUP_NAMED_BIND GROUP_NAMED_ADDRESS_DELIVERED GROUP_NAMED_SINGLE_COPY GROUP_LISTENER_LOOPBACK GROUP_PORT_ZERO_ECONNREFUSED"),
    ...
    "socket_sol_socket_table": ("portable-differential", "pass", "GET_SHORT_REPORTS_COPY GET_LINGER_CLAMPED GET_ZERO_LENGTH SET_TYPE_ENOPROTOOPT SET_SNDLOWAT_ENOPROTOOPT SET_PROTOCOL_ENOPROTOOPT SET_SHORT_OPTLEN_EINVAL SET_LINGER_SHORT_EINVAL SET_BAD_LEVEL_ENOPROTOOPT GET_BAD_LEVEL_ENOPROTOOPT SET_NEGATIVE_OPTLEN_EINVAL NEGATIVE_SNDBUF_CLAMPS NEGATIVE_SNDBUF_READS_MAX NEGATIVE_RCVBUF_CLAMPS NEGATIVE_RCVBUF_READS_MAX INET_NEGATIVE_SNDBUF_CLAMPS INET_NEGATIVE_SNDBUF_READS_MAX INET_NEGATIVE_RCVBUF_CLAMPS INET_NEGATIVE_RCVBUF_READS_MAX RCVTIMEO_FRESH_ZERO SNDTIMEO_FRESH_ZERO RCVTIMEO_JIFFY_ROUND_TRIP SNDTIMEO_ROUND_TRIP RCVTIMEO_INVALID_USEC_EDOM RCVTIMEO_NEGATIVE_SECONDS_ZERO RCVTIMEO_SHORT_LEN_EINVAL BSDCOMPAT_READS_ZERO PEEK_OFF_SET_EOPNOTSUPP PEEK_OFF_GET_EOPNOTSUPP RCVBUFFORCE_UNCLAMPED SNDBUFFORCE_UNCLAMPED SNDBUF_DEFAULT_ADMITS_212960 SNDBUF_DEFAULT_REFUSES_212961 SNDBUF_RAISED_ADMITS_400000 SNDBUF_FLOOR_4608 SNDBUF_FLOOR_ADMITS_4576 SNDBUF_FLOOR_REFUSES_4577 RCVBUF_FIRST_DATAGRAM_ADMITTED RCVBUF_SECOND_DATAGRAM_EAGAIN GET_NEGATIVE_OPTLEN_EINVAL GET_UNREADABLE_OPTLEN_EFAULT GET_UNKNOWN_LEVEL_NEGATIVE_OPTLEN_EOPNOTSUPP GET_UNKNOWN_LEVEL_UNREADABLE_OPTLEN_EOPNOTSUPP GET_UNKNOWN_LEVEL_EOPNOTSUPP BINDTODEVICE_NETLINK_FRESH_UNBOUND BINDTODEVICE_NETLINK_ROUND_TRIP BINDTODEVICE_NETLINK_SHORT_BUFFER_EINVAL BINDTODEVICE_NETLINK_LONG_REQUEST_TRUNCATES BINDTODEVICE_NETLINK_UNKNOWN_NAME_ENODEV BINDTODEVICE_NETLINK_UNREADABLE_NAME_EFAULT BINDTODEVICE_NETLINK_EMPTY_UNBINDS BINDTODEVICE_NETLINK_REBIND_ALLOWED BINDTODEVICE_UNIX_ROUND_TRIP BINDTODEVICE_PACKET_ROUND_TRIP UNPRIVILEGED_RCVBUFFORCE_EPERM UNPRIVILEGED_BINDTODEVICE_FIRST_SET UNPRIVILEGED_BINDTODEVICE_REBIND_EPERM"),
...
CONTRACTS.update({
    "gettimeofday": ("raw-differential", "pass", "READ_BRACKETS_CLOCK_REALTIME NULL_ARGUMENTS_ACCEPTED TIMEZONE_ONE_SHOT_SPENT_BY_TV_STORE TIMEZONE_ROUND_TRIP MONOTONIC_RAW_SHARES_MONOTONIC_OFFSET TIMEZONE_EFAULT"),
    "settimeofday": ("raw-differential", "pass", "SUBSECOND_EINVAL_BEFORE_TIMEZONE TIMEZONE_EFAULT_BEFORE_SECONDS SUBSECOND_EINVAL_BEFORE_SECONDS TIMEZONE_RANGE_EINVAL_PRESERVES SET_TO_TIME_BOUND_EINVAL BEFORE_MONOTONIC_EINVAL"),
    "settimeofday-unprivileged": ("raw-differential", "pass", "BOUND_BEFORE_CAPABILITY CAPABILITY_BEFORE_TIMEZONE_RANGE ALARM_FLAGS_BEFORE_CAPABILITY"),
    "clock_settime": ("raw-differential", "pass", "CLOCK_CLASSIFICATION_EINVAL COPY_IN_EFAULT CPU_CLOCK_EPERM_AFTER_COPY SET_TO_TIME_BOUND_EINVAL BEFORE_MONOTONIC_EINVAL"),
    "clock_getres": ("raw-differential", "pass", "SCHEDULER_CLOCKS_ARE_NANOSECOND ACCOUNTING_CLOCKS_EXCEED_NANOSECOND NULL_AND_UNKNOWN_IDS PID_RESOLUTION_BEFORE_RESOLUTION_VALUE"),
    "clock_nanosleep": ("raw-differential", "pass", "UNSUPPORTED_CLOCKS_EOPNOTSUPP_BEFORE_COPY UNKNOWN_CLOCK_EINVAL SUPPORTED_CLOCK_COPY_BEFORE_VALIDATION UNKNOWN_FLAGS_IGNORED ALARM_OUTCOME_MATCHES_CONFIG ENCODED_SELF_THREAD_IS_EINVAL PROCESS_CPUTIME_ZERO_INTERVAL"),
    "adjtimex": ("raw-differential", "pass", "BARE_READ_INITIAL_STATE UNKNOWN_MODE_BITS_ECHOED ADJ_ADJTIME_REQUIRES_SINGLESHOT SINGLESHOT_RETURNS_PREVIOUS SS_READ_REPORTS_RESIDUAL STATUS_READONLY_BITS_DROPPED NANO_RESOLUTION_RENDER OFFSET_TRUNCATION_BOUNDED_BY_ONE_NANOSECOND MICRO_RESOLUTION_CLAMPS MICRO_WINS_OVER_NANO TAI_OFFSET_READBACK SETOFFSET_DISCONTINUITY SETOFFSET_VALIDATION"),
    ...
    "identity-ids": ("raw-differential", "pass", "PLAIN_GETTER_AGREEMENT DISTINCT_ID_FIELDS RESID_FAULT_PREFIX_ORDER"),
    "identity-switch": ("raw-differential", "pass", "SETUID_CAPABILITY_BRANCH SETUID_SAVED_ID_ADMISSION SETGID_CAPABILITY_BRANCH CREDENTIAL_CHANGES_STAY_IN_CHILD"),
    "identity-groups": ("raw-differential", "pass", "GETGROUPS_LENGTH_PROTOCOL SETGROUPS_SORT_AND_STATE SETGROUPS_ADMISSION_BEFORE_VALIDATION GROUP_LIST_CHANGES_STAY_IN_CHILD"),
    "identity-fsids": ("raw-differential", "pass", "SETFSUID_RETURNS_PRIOR_AND_OWNS_FILE SETFSGID_RETURNS_PRIOR_AND_OWNS_FILE UNPRIVILEGED_FSID_REQUEST_IS_A_QUERY FSUID_PUBLICATION_UPDATES_FILESYSTEM_CAPS"),
    "identity-limits": ("raw-differential", "pass", "GETRLIMIT_SNAPSHOT_AND_ERRORS SETRLIMIT_AND_PRLIMIT64_VALIDATION_ORDER LIMIT_MUTATION_AND_CAPABILITY_BRANCH PRLIMIT64_CROSS_PROCESS_ADMISSION LIMIT_CHANGES_STAY_IN_CHILD"),
    "identity-usage": ("raw-differential", "pass", "SELECTOR_VALIDATION_ORDER SELF_AND_THREAD_ACCOUNTING CHILDREN_LEDGER_EXCLUDES_SELF CHILDREN_LEDGER_AFTER_WAIT"),
    "identity-personality": ("raw-differential", "pass", "QUERY_AND_REPLACE_RETURNS_PRIOR UNAME_OVERRIDES_FOLLOW_PERSONALITY"),
    "identity-uts": ("raw-differential", "pass", "HOSTNAME_ERROR_ORDER DOMAINNAME_ERROR_ORDER PRIVATE_UTS_MUTATION GLOBAL_UTS_NAMES_UNCHANGED"),
    "time-timer": ("raw-differential", "pass", "NANOSLEEP_REQUEST_RANGE ITIMER_WHICH_EINVAL ALARM_ARM_AND_REMAINDER TIMES_NULL_ACCEPTED TIMER_ARM_READ_BACK_AND_DELETE SIGEV_NONE_DISARM_REPORTS_STALE_EXPIRY TIMERFD_ARM_READ_BACK"),
    ...
    "timer_getoverrun": ("raw-differential", "pass", "ZERO_BEFORE_FIRST_SIGNAL INVALID_ID_EINVAL SIGEV_NONE_NEVER_LATCHES_OVERRUN"),
    "wait4": ("raw-differential", "pass", "wait4-int-min-esrch wait4-unknown-option wait4-wnowait-unknown wait4-wnohang-flags-zero wait4-wclone-excludes-sigchld wait4-wuntraced-reports-stop wait4-stop-consumed-once wait4-wcontinued-reports-continue wait4-continue-consumed-once wait4-wnohang-zero wait4-reaped-child-echild wait4-wnothread-thread-create wait4-wnothread-sibling-echild wait4-wnothread-any-live-zero wait4-wnothread-own-live-zero wait4-wnothread-zombie-sibling-echild wait4-wnothread-zombie-group-reap wait4-wnothread-thread-join"),
    "waitid": ("raw-differential", "pass", "waitid-unknown-option waitid-no-event-bit waitid-nowait-alone waitid-p-pid-zero waitid-p-pid-negative waitid-p-pgid-negative waitid-p-pidfd-negative waitid-bad-idtype waitid-p-all-ignores-upid waitid-echild-zeroes-info waitid-rusage-fault-before-info waitid-wnohang-zeroes-info waitid-nowait-preserves-stop waitid-consume-after-nowait waitid-consumed-once waitid-exited-status waitid-reaped-child-echild"),
    "sched_rr_get_interval": ("raw-differential", "pass", "rr-negative-pid rr-self-succeeds rr-fifo-is-infinity rr-null-interval"),
    "sched_attr": ("raw-differential", "pass", "setattr-size-zero-means-ver0 setattr-size-47-e2big setattr-size-4097-e2big setattr-err-size-writes-back setattr-negative-pid setattr-nonzero-flags setattr-null-attr setattr-reclaim-on-other setattr-overrun-on-other setattr-restore setattr-unknown-flag getattr-size-47-einval getattr-size-0-einval getattr-size-4097-einval getattr-size-page-accepted getattr-page-clears-tail getattr-size-4097-einval getattr-null-attr getattr-negative-pid getattr-unknown-flags getattr-dl-dynamic-on-other getattr-unknown-flag-bad-pid-esrch getattr-ver0-fields"),
    "mempolicy": ("raw-differential", "pass", "mbind-unaligned-start mbind-unknown-flag mbind-bad-mode-before-mask set_mempolicy-bad-mode set_mempolicy-balancing-default set_mempolicy-balancing-preferred set_mempolicy-balancing-interleave set_mempolicy-static-and-relative set_mempolicy-balancing-bind-reads-mask set_mempolicy-balancing-preferred-many-reads-mask set_mempolicy-static-bind-reads-mask set_mempolicy-relative-bind-reads-mask set_mempolicy-maxnode-too-long set_mempolicy-maxnode-at-bound-faults set_mempolicy-mask-ptr-fault set_mempolicy-bind-mask-ptr-fault set_mempolicy-prefered-mask-ptr-fault set_mempolicy-default-accepts-empty-mask set_mempolicy-default-accepts-absent-mask set_mempolicy-default-rejects-nonempty-mask set_mempolicy-bind-rejects-empty-mask set_mempolicy-bind-rejects-absent-mask set_mempolicy-preferred-empty-is-local set_mempolicy-restore-default set_mempolicy-preferred-disallowed-mask mbind-zero-length-skips-mask-validation mbind-move-all-unprivileged-eperm get_mempolicy-mems-allowed-skips-addr get_mempolicy-addr-without-flag get_mempolicy-unknown-flags get_mempolicy-f-node-without-addr get_mempolicy-tiny-maxnode get_mempolicy-mems-allowed-tiny-maxnode get_mempolicy-mems-allowed-zero-policy get_mempolicy-mems-allowed-policy-fault get_mempolicy-f-node-addr-writes-mask set_mempolicy-static-bind-keeps-user-mask get_mempolicy-reports-mode-and-user-mask set_mempolicy-restore-default-after-static set_mempolicy-mask-bit-above-max-numnodes mbind-default-spans-middle-hole mbind-default-strict-spans-middle-hole mbind-local-rejects-middle-hole mbind-bind-rejects-middle-hole mbind-default-whole-range-hole mbind-default-spans-head-hole set_mempolicy-checks-high-word-first set_mempolicy-default-drops-mode-flags get_mempolicy-default-keeps-no-mode-flags get_mempolicy-f-node-addr-unpopulated get_mempolicy-f-node-addr-prot-none get_mempolicy-f-node-addr-hole get_mempolicy-f-addr-prot-none-reports-vma-policy get_mempolicy-f-node-interleave-task-policy get_mempolicy-f-node-weighted-interleave-task-policy get_mempolicy-f-node-preferred-many-einval get_mempolicy-clears-window-past-node-mask get_mempolicy-window-too-long-keeps-policy"),
    ...
    "quotactl": ("raw-differential", "pass", "TYPE_BEFORE_PATH BLOCK_DEVICE_REQUIRED NULL_SPECIAL_ERRNO SYNC_ALL_WITHOUT_SPECIAL QUOTA_TYPE_ACTIVATION QUOTA_LIMIT_UNITS QUOTA_NEXT_ID_INCLUSIVE QUOTA_ID_ZERO_INFO_ROUTING QUOTA_UNHANDLED_SELECTORS_EINVAL QUOTA_OVER_MAXIMUM_ERANGE QUOTA_TYPE_DEACTIVATION"),
...
CONTRACTS.update({
    ...
    "sysadmin-abi.unshare-flags": ("raw-differential", "pass", "UNSHARE_ZERO_NOOP UNSHARE_THREAD_NOOP UNSHARE_SIGHAND_NOOP UNSHARE_VM_NOOP UNSHARE_THREAD_FS_NOOP UNSHARE_FILES_OK UNSHARE_PIDFD_EINVAL UNSHARE_SETTLS_EINVAL UNSHARE_IO_EINVAL UNSHARE_CLEAR_SIGHAND_EINVAL UNSHARE_EMPTY_MNTNS_ACCEPTED UNSHARE_EMPTY_MNTNS_ROOT_IS_NAMESPACE_ROOT UNSHARE_EMPTY_MNTNS_DROPS_SUBMOUNTS"),
    ...
    "sysadmin-abi.kexec-load": ("raw-differential", "pass", "KEXEC_RESERVED_FLAG_BIT_EINVAL KEXEC_UNKNOWN_ARCH_EINVAL KEXEC_SEGMENT_COUNT_OVER_MAX_EINVAL KEXEC_UNALIGNED_DESTINATION_EADDRNOTAVAIL KEXEC_DESTINATION_ABOVE_LIMIT_EADDRNOTAVAIL KEXEC_BUFSZ_OVER_MEMSZ_EINVAL KEXEC_ADDRESS_ERROR_PRECEDES_BUFSZ_ERROR KEXEC_OVERLAPPING_DESTINATIONS_EINVAL KEXEC_ZERO_LENGTH_DESTINATION_ACCEPTED KEXEC_UNLOAD_AFTER_ZERO_LENGTH_ACCEPTED"),
    "memfd-create": ("portable-differential", "pass", "MFD_FLAG_VALIDATION MFD_NAME_RULES MFD_CLOEXEC_STATE MFD_INODE_MODE MFD_SEAL_ADMISSION MFD_FILE_SHAPE"),
    "identity-pgid": ("raw-differential", "pass", "GETPGRP_AND_GETPGID_AGREE GETPGID_ERRORS GETSID_SELF_AND_ERRORS SETSID_MAKES_A_NEW_SESSION_AND_REFUSES_TWICE"),
    "identity-setres": ("raw-differential", "pass", "SETRESUID_NOOP_AND_FSUID_FOLLOWS_EUID_APPLIED SETRESUID_FULL_TRIPLE_AND_CAPABILITY_BRANCH SETRESGID_FULL_TRIPLE_AND_CAPABILITY_BRANCH SETREUID_SAVED_ID_FOLLOWS_EFFECTIVE SETREGID_SAVED_ID_FOLLOWS_EFFECTIVE"),
    "identity-capget": ("raw-differential", "pass", "EFFECTIVE_SET_MATCHES_GETPID_CAPS VERSION_VALIDATION_WRITES_PREFERRED_VERSION PID_SELECTOR_AND_ERRORS"),
    "futex-abi-requeue-pi-owned": ("portable-differential", "pass", "OWNED_RC OWNED_WORD WAITER_BLOCKED HANDOFF_WORD WAITER_RC UNLOCKED"),
    "futex-abi-requeue-pi-held": ("portable-differential", "pass", "HELD_RC HELD_WORD WAITER_BLOCKED HANDOFF_WORD WAITER_RC UNLOCKED"),
    "futex-abi-requeue-pi-plain": ("portable-differential", "pass", "PLAIN_SOURCE_EINVAL TARGET_UNTOUCHED WAKE_RC WAITER_RC"),
    "sysvipc-limits": ("namespace-isolation", "pass", "CEILING_DEFAULTS_MATCH_UAPI CEILINGS_ARE_IPC_NAMESPACE_LOCAL ZERO_CEILING_REFUSES_CREATION CEILING_WRITE_RANGE_ERRORS WRAPPED_SIZE_IS_ENOSPC"),
    "sysvipc-semget-bounds": ("nsems-before-key", "pass", "OVERSIZE_NSEMS_EINVAL_BEFORE_KEY_LOOKUP ZERO_NSEMS_ACCEPTED_FOR_LIVE_KEY ZERO_NSEMS_EINVAL_FOR_NEW_SET"),
    "sysvipc-task-pid": ("nested-pid-namespace", "pass", "MSG_LSPID_RENDERS_PID_VNR MSG_LRPID_RENDERS_PID_VNR SEM_GETPID_RENDERS_PID_VNR"),
    "sysvipc-shmat-range": ("address-limit", "pass", "MISALIGNED_ADDRESS_EINVAL ALIGNED_ADDRESS_ABOVE_TASK_SIZE_ENOMEM"),
    ...
    "sysvipc-sem-undo-unshare": ("unshare-detaches", "pass", "UNSHARE_APPLIES_UNDO_ONCE"),
    ...
    "sysvipc-errno": ("order", "pass", "SEMOP_EFBIG_BEFORE_EACCES MSGSND_FAULTS_BEFORE_VALIDATION MSGSND_SIZE_AND_TYPE_BEFORE_ID TABLE_COMMANDS_REJECT_NEGATIVE_ID SEMCTL_VALUE_AND_SEMNUM_ORDER SEMTIMEDOP_COUNT_AND_TIMEOUT_ORDER MSGRCV_NEGATIVE_SIZE_EINVAL IPC_SET_COPY_BEFORE_IDENTIFIER SEMOP_VECTOR_COPY_BEFORE_VALIDATION"),
    "sysvipc-owner": ("set", "pass", "OWNER_HANDS_OBJECT_TO_UNHELD_ID"),
    "sysvipc-record": ("layout", "pass", "MSQID_DS_LAYOUT_MATCHES_LINUX SEMID_DS_LAYOUT_MATCHES_LINUX SHMID_DS_LAYOUT_MATCHES_LINUX"),
    "sysvipc-msg": ("exclusive-create-order", "pass", "EXCLUSIVE_CREATE_BEFORE_PERMISSION"),
    "mq_open": ("raw-differential", "pass", "DEFAULT_ATTRIBUTES HARD_LIMIT_CAPABILITY RLIMIT_CHARGE_BOUNDARY OPEN_EXISTING_PRECEDENCE CREATE_ACCMODE_THREE NAME_SYNTAX NAME_LENGTH_BOUNDARY OPEN_FD_LIFETIME FD_CLOEXEC_UNCONDITIONAL"),
    ...
    "mq_notify": ("raw-differential", "pass", "ONE_SHOT_EMPTY_EDGE EMPTY_EDGE_REARM ARGUMENT_VALIDATION PIPELINED_RECEIVE_SKIPS_NOTIFY DESCRIPTOR_FLUSH_DISARMS"),
})
CONTRACTS.update({
    "socket_msg.sendmmsg_flags": ("raw-differential", "pass", "SENDMMSG_TWO SENDMMSG_TWO_RECORDS SENDMMSG_EOR SENDMMSG_EOR_RECORD SENDMMSG_UNDEFINED_FLAG SENDMMSG_UNDEFINED_RECORD SENDMMSG_HEADER_FLAGS_IGNORED SENDMMSG_MORE_CORKS SENDMMSG_MORE_PENDING SENDMMSG_MORE_FLUSH SENDMMSG_MORE_MERGED OOB_SENDMMSG_STREAM_BYTES"),
    "socket_msg.peek_waitall_tcp": ("raw-differential", "pass", "TCP_PEEK_LISTENER TCP_PEEK_HELPER TCP_PEEK_CONNECT TCP_PEEK_TEN TCP_PEEK_LEAVES_QUEUE TCP_PEEK_JOIN TCP_PEEK_DONE"),
    "socket_name_record": ("portable-differential", "pass", "GETSOCKNAME_UNBOUND_ZERO NAME_BIND GETSOCKNAME_BOUND_PORT GETPEERNAME_UNCONNECTED_ENOTCONN GETSOCKNAME_BADLEN_EFAULT GETSOCKNAME_LENGTH_BEFORE_FAULT RECVFROM_NAME_SOCKET RECVFROM_LENGTH_BEFORE_FAULT AUTOBIND_NAME_BIND UNIX_AUTOBIND_NAME_RECORD RECVFROM_CONNECTED_STREAM_NAME_ABSENT RECVMSG_CONNECTED_STREAM_NAME_ABSENT RECVFROM_CONNECTED_STREAM_NEGATIVE_LENGTH_EINVAL RECVFROM_DATAGRAM_NAME_PRESENT"),
    "futex-abi-waitv-numa": ("portable-differential", "pass", "PROBE_EINVAL NO_NODE_WRITEBACK ALIGN_EINVAL BAD_NODE_EINVAL RO_NODE_EFAULT"),
    "futex-abi-requeue-pi-signal": ("portable-differential", "pass", "REQUEUED_WAITER_EWOULDBLOCK"),
    "futex-abi-pi-signal": ("portable-differential", "pass", "LOCK_PI_SA_RESTART_RESUMES"),
    "sched_query": ("raw-differential", "pass", "sched-getscheduler-negative-pid sched-getscheduler-unknown-pid sched-getparam-negative-pid sched-getparam-null-param sched-getparam-unknown-pid sched-getscheduler-self sched-getparam-self sched-query-child-batch sched-query-zombie-waitid sched-getscheduler-zombie-keeps-policy sched-getparam-zombie-reports-zero sched-getscheduler-after-reap sched-getparam-after-reap sched-getscheduler-exiting-keeps-policy"),
    "setpriority": ("raw-differential", "pass", "setpriority-limited-child-ready setpriority-target-rlimit-nice-eacces setpriority-cap-sys-nice-lowers setpriority-zombie-exited setpriority-zombie-target-rlimit-nice getpriority-zombie-lowered-nice setpriority-zombie-above-target-rlimit-eacces"),
    "ioprio": ("raw-differential", "pass", "ioprio-set-none-with-level ioprio-set-invalid-class ioprio-set-bad-which ioprio-get-bad-which ioprio-set-self ioprio-get-self-roundtrip ioprio-set-self-none ioprio-get-self-reports-stored-none ioprio-get-pgrp-derives-from-nice ioprio-get-pgrp-best-of-group ioprio-zombie-reports-default ioprio-zombie-set-is-a-noop ioprio-zombie-keeps-default ioprio-get-after-reap ioprio-set-after-reap"),
    ...
    "sysinfo": ("raw-differential", "pass", "FIELD_CONSISTENCY NULL_BUF_EFAULT BAD_PTR_EFAULT"),
...
CONTRACTS.update({
    ...
    "rt_sigreturn": ("raw-differential", "pass", "FRAME_MASK_RESTORED BAD_FRAME_FATAL_SIGSEGV"),
    "pause": ("raw-differential", "pass", "EINTR_AFTER_HANDLER FATAL_SIGNAL_TERMINATES_WAITER"),
    "getpid": ("raw-differential", "pass", "getpid-main-tid-equals-pid getpid-thread-shares-tgid getpid-child-fork getpid-child-own-identity getpid-child-distinct-from-parent getpid-pidns-init-is-one"),
    "kill": ("raw-differential", "pass", "INT_MIN_ESRCH LOOKUP_BEFORE_SIGNO NULL_SIGNAL_PROBES SI_USER_SENDER_RECORDED PROCESS_GROUP_DELIVERY REAPED_TARGET_ESRCH"),
    "getppid": ("raw-differential", "pass", "getppid-child-fork getppid-child-sees-parent getppid-main-parent-alive getppid-thread-shares-parent getppid-pidns-invisible-parent-zero getppid-orphan-fork getppid-orphan-reparented-to-init"),
    "getpgrp": ("raw-differential", "pass", "getpgrp-matches-getpgid-zero getpgrp-child-fork getpgrp-child-inherits-group getpgrp-child-own-group getpgrp-parent-observes-child-group"),
    "setsid": ("raw-differential", "pass", "setsid-child-fork setsid-inherits-parent-session setsid-returns-new-session-id setsid-parent-observes-new-session setsid-twice-eperm"),
    "setreuid": ("raw-differential", "pass", "setreuid-baseline-root setreuid-sentinel-pair-noop setreuid-real-change-keeps-effective setreuid-privileged-restore setreuid-effective-change-sets-saved setreuid-restore-after-effective setreuid-drop-all-identities setreuid-unprivileged-real-refused setreuid-unprivileged-effective-refused setreuid-reachable-ids-allowed"),
    "setregid": ("raw-differential", "pass", "setregid-baseline-root setregid-sentinel-pair-noop setregid-real-change-keeps-effective setregid-privileged-restore setregid-effective-change-sets-saved setregid-restore-after-effective setregid-drop-all-identities setregid-group-capability-follows-uid setregid-saved-identity-unchanged setregid-privileged-restore-before-drop setregid-drop-uid-keeps-gids setregid-unprivileged-real-refused setregid-unprivileged-effective-refused setregid-reachable-ids-allowed"),
    "setresuid": ("raw-differential", "pass", "setresuid-baseline-root setresuid-all-sentinels-noop setresuid-effective-only-change setresuid-privileged-restore setresuid-real-only-change setresuid-restore-after-real setresuid-drop-all-identities setresuid-unprivileged-effective-refused setresuid-unprivileged-real-refused setresuid-reachable-ids-allowed"),
    "setresgid": ("raw-differential", "pass", "setresgid-baseline-root setresgid-all-sentinels-noop setresgid-effective-only-change setresgid-privileged-restore setresgid-real-only-change setresgid-restore-after-real setresgid-drop-all-identities setresgid-group-capability-follows-uid setresgid-saved-identity-moved-by-request setresgid-privileged-restore-before-drop setresgid-drop-uid-keeps-gids setresgid-unprivileged-effective-refused setresgid-unprivileged-real-refused setresgid-reachable-ids-allowed"),
    "getpgid": ("raw-differential", "pass", "getpgid-zero-is-caller getpgid-self-by-pid getpgid-missing-esrch getpgid-child-fork getpgid-named-child getpgid-child-self-report getpgid-zombie-fork getpgid-zombie-observe getpgid-zombie-reports-group"),
    "getsid": ("raw-differential", "pass", "getsid-zero-is-caller getsid-missing-esrch getsid-child-fork getsid-child-new-session getsid-parent-observes-child-session getsid-child-session-differs-from-parent getsid-zombie-fork getsid-zombie-observe getsid-zombie-reports-session"),
    "rt_sigpending": ("raw-differential", "pass", "SIZE_ABOVE_SET_EINVAL ZERO_SIZE_NO_COPY SHORT_SIZE_PARTIAL_COPY BLOCKED_PENDING_VISIBLE FAULT_PRESERVES_PENDING DELIVERED_CLEARS_PENDING"),
    "rt_sigtimedwait": ("raw-differential", "pass", "SIZE_BEFORE_COPY COPY_BEFORE_TIMEOUT INVALID_TIMEOUT_EINVAL EMPTY_SELECTION_EAGAIN DEQUEUE_PENDING_SIGINFO INFO_FAULT_AFTER_DEQUEUE TIMEOUT_EXPIRES_EAGAIN"),
    "rt_sigqueueinfo": ("raw-differential", "pass", "COPY_BEFORE_TARGET IMPERSONATION_BEFORE_LOOKUP QUEUED_RECORD_VERBATIM INVALID_SIGNO_EINVAL IMPERSONATION_BEFORE_SIGNO"),
    "rt_sigsuspend": ("raw-differential", "pass", "SIZE_AND_COPY_RULES ATOMIC_SWAP_EINTR RESTORES_CALLER_MASK"),
    "gettid": ("raw-differential", "pass", "gettid-main-equals-pid gettid-thread-unique gettid-thread-addressable gettid-thread-gone-esrch gettid-child-fork gettid-child-single-threaded"),
    "tkill": ("raw-differential", "pass", "NONPOSITIVE_TID_EINVAL LOOKUP_BEFORE_SIGNO NULL_SIGNAL_PROBES THREAD_PRIVATE_DELIVERY"),
    "set_tid_address": ("raw-differential", "pass", "set_tid_address-returns-visible-tid set_tid_address-unprobed-address set_tid_address-thread-clone set_tid_address-thread-exit-clears-word set_tid_address-thread-exit-wakes-futex set_tid_address-process-exit-fork set_tid_address-process-exit-keeps-word"),
...
PROGRAM_CASES = {
    ...
    "sysadmin-abi": ("sysadmin-abi.ptrace-requests", "sysadmin-abi.unshare-flags", "sysadmin-abi.swap-flags", "sysadmin-abi.module-image", "sysadmin-abi.kexec-load"),
    "sysv-ipc": ("sysvipc-limits", "sysvipc-semget-bounds", "sysvipc-task-pid", "sysvipc-shmat-range", "sysvipc-ids", "sysvipc-stat", "sysvipc-info", "sysvipc-sem", "sysvipc-sem-undo", "sysvipc-sem-undo-unshare", "sysvipc-control", "sysvipc-shm-lock", "sysvipc-shm-hugetlb", "sysvipc-shm-dest", "sysvipc-errno", "sysvipc-msg", "sysvipc-owner", "sysvipc-record"),
...
PROGRAM_SUCCESS = {
    ...
    "identity": "THEKERNEL_IDENTITY_OK",
...
SYSCALL_CASES = {
    ...
    39: ("wait-abi", "getpid"),
    62: ("signal-boundary", "kill"),
    110: ("wait-abi", "getppid"),
    127: ("signal-boundary", "rt_sigpending"),
    128: ("signal-boundary", "rt_sigtimedwait"),
    129: ("signal-boundary", "rt_sigqueueinfo"),
    130: ("signal-boundary", "rt_sigsuspend"),
    186: ("wait-abi", "gettid"),
    200: ("signal-boundary", "tkill"),
    218: ("wait-abi", "set_tid_address"),
    234: ("signal-boundary", "tgkill"), 319: ("memfd-create", "memfd-create"), 121: ("identity", "identity-pgid"), 112: ("identity", "identity-pgid"), 124: ("identity", "identity-pgid"),
    113: ("identity", "identity-setres"), 114: ("identity", "identity-setres"), 117: ("identity", "identity-setres"), 119: ("identity", "identity-setres"),
    125: ("identity", "identity-capget"),
    68: ("sysv-ipc", "sysvipc-limits"), 456: ("futex-abi", "futex-abi-requeue-pi-plain"), 64: ("sysv-ipc", "sysvipc-semget-bounds"), 70: ("sysv-ipc", "sysvipc-task-pid"), 30: ("sysv-ipc", "sysvipc-shmat-range"),
    102: ("identity", "identity-ids"),
    107: ("identity", "identity-ids"),
    104: ("identity", "identity-ids"),
    108: ("identity", "identity-ids"),
    118: ("identity", "identity-ids"),
    120: ("identity", "identity-ids"),
    105: ("identity", "identity-switch"),
    106: ("identity", "identity-switch"),
    115: ("identity", "identity-groups"),
    116: ("identity", "identity-groups"),
    122: ("identity", "identity-fsids"),
    123: ("identity", "identity-fsids"),
    97: ("identity", "identity-limits"),
    160: ("identity", "identity-limits"),
    302: ("identity", "identity-limits"),
    98: ("identity", "identity-usage"),
    135: ("identity", "identity-personality"),
    170: ("identity", "identity-uts"),
    171: ("identity", "identity-uts"),
    0: ("fs-abi", "fs-basic"),
    35: ("time-abi", "time-timer"),
    36: ("time-abi", "time-timer"),
    37: ("time-abi", "time-timer"),
    38: ("time-abi", "time-timer"),
    100: ("time-abi", "time-timer"),
    223: ("time-abi", "time-timer"),
    224: ("time-abi", "time-timer"),
    226: ("time-abi", "time-timer"),
    283: ("time-abi", "time-timer"),
    287: ("time-abi", "time-timer"),
    2: ("fs-abi", "fs-path"),
    22: ("fs-abi", "fs-path"),
    78: ("fs-abi", "fs-path"),
    80: ("fs-abi", "fs-path"),
    ...
    188: ("fsattrs", "xattr-classic"),
    189: ("fsattrs", "xattr-classic"),
    190: ("fsattrs", "xattr-classic"),
    191: ("fsattrs", "xattr-classic"),
    192: ("fsattrs", "xattr-classic"),
    193: ("fsattrs", "xattr-classic"),
    194: ("fsattrs", "xattr-classic"),
    195: ("fsattrs", "xattr-classic"),
    196: ("fsattrs", "xattr-classic"),
    197: ("fsattrs", "xattr-classic"),
    198: ("fsattrs", "xattr-classic"),
    199: ("fsattrs", "xattr-classic"),
    ...
    51: ("socket-provider", "socket_name_record"),
    52: ("socket-provider", "socket_name_record"),
    ...
    425: ("io-uring-register", "io-uring-register"),
    427: ("io-uring-register", "io-uring-register"),
    ...
    246: ("sysadmin-abi", "sysadmin-abi.kexec-load"),
