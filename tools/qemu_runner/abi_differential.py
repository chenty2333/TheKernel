...
CONTRACTS.update({
    ...
    "landlock-restrict-self": ("raw-differential", "pass", "NO_RULESET_MATRIX RULESET_DESCRIPTOR_ERRORS TSYNC_SYNCHRONIZES_SIBLINGS NO_TSYNC_LEAVES_SIBLING"),
...
CONTRACTS.update({
    ...
    "sysadmin-abi.module-image": ("raw-differential", "pass", "INIT_MODULE_ZERO_LEN_ENOEXEC INIT_MODULE_SHORT_IMAGE_ENOEXEC INIT_MODULE_HEADER_SIZE_NULL_EFAULT DELETE_MODULE_EMPTY_NAME_ENOENT DELETE_MODULE_UNKNOWN_NAME_ENOENT DELETE_MODULE_STRAY_FLAGS_STILL_ENOENT"),
