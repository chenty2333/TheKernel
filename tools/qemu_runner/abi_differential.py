...
CONTRACTS.update({
    ...
    "sched_query": ("raw-differential", "pass", "sched-getscheduler-negative-pid sched-getscheduler-unknown-pid sched-getparam-negative-pid sched-getparam-null-param sched-getparam-unknown-pid sched-getscheduler-self sched-getparam-self sched-query-pipe sched-query-fork sched-query-child-batch sched-query-zombie-waitid sched-getscheduler-zombie-keeps-policy sched-getparam-zombie-reports-zero sched-getscheduler-after-reap sched-getparam-after-reap"),
    "setpriority": ("raw-differential", "pass", "setpriority-pipe setpriority-fork setpriority-limited-child-ready setpriority-target-rlimit-nice-eacces setpriority-cap-sys-nice-lowers"),
    "ioprio": ("raw-differential", "pass", "ioprio-set-none-with-level ioprio-set-invalid-class ioprio-set-bad-which ioprio-get-bad-which ioprio-set-self ioprio-get-self-roundtrip ioprio-set-self-none ioprio-get-self-reports-stored-none ioprio-group-pipe ioprio-group-fork ioprio-get-pgrp-derives-from-nice ioprio-get-pgrp-best-of-group ioprio-get-pgrp-best-of-group ioprio-zombie-fork ioprio-zombie-reports-default ioprio-zombie-set-is-a-noop ioprio-zombie-keeps-default ioprio-get-after-reap ioprio-set-after-reap"),
    "ptrace_stop": ("raw-differential", "pass", "ptrace-traceme-fork wait4-traceme-stop-without-wuntraced waitid-traceme-stop-is-cld-trapped ptrace-tracee-resumes-and-reaps-after-detach"),
