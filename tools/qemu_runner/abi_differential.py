...
CONTRACTS.update({
    ...
    "munmap": ("raw-differential", "pass", "HOLE_NEIGHBORS_IDEMPOTENT VALIDATION_PRESERVES_NEIGHBORS SHARED_ANON_PARTIAL_UNMAP"),
...
CONTRACTS.update({
    "utime": ("raw-differential", "pass", "TIMES_EFAULT_BEFORE_PATH EXPLICIT_SECONDS_NANOS_ZERO MISSING_PATH_ENOENT NULL_TIMES_SETS_NOW SYMLINK_FOLLOWS_TARGET TOUCH_MAY_WRITE EXPLICIT_TIMES_OWNER_ONLY TOUCH_WITHOUT_WRITE_EACCES"),
    "utimes": ("raw-differential", "pass", "TIMES_EFAULT_BEFORE_PATH USEC_RANGE_BEFORE_PATH NEGATIVE_USEC_EINVAL SPECIAL_VALUES_REJECTED MICROSECOND_PRECISION NULL_TIMES_SETS_NOW NULL_TIMES_MISSING_PATH_ENOENT PARTIAL_FAULT_LEAVES_TIMES"),
    "futimesat": ("raw-differential", "pass", "TIMES_EFAULT_BEFORE_FD USEC_RANGE_BEFORE_FD NULL_PATH_BAD_FD_EBADF AT_FDCWD_NULL_PATH_EFAULT NULL_PATH_OPATH_FD_EBADF FD_FORM_MICROSECOND_PRECISION FD_FORM_NULL_TIMES_NOW PSEUDO_INODE_DESCRIPTOR_FORM RELATIVE_PATH_TO_FD RELATIVE_MISSING_ENOENT BAD_DIRFD_EBADF EMPTY_PATH_ENOENT UNLINKED_FD_FORM_OK"),
    "fchmodat2": ("raw-differential", "pass", "FLAGS_BEFORE_PATH FLAGS_MASK_BEFORE_NULL_PATH EMPTY_PATH_WITHOUT_FLAG_ENOENT EMPTY_PATH_BAD_FD_EBADF NULL_PATH_EFAULT EMPTY_PATH_OPATH_FD_COMMITS_MODE NAMED_PATH_WITH_EMPTY_FLAG_COMMITS_MODE MODE_BITS_VERBATIM SYMLINK_NOFOLLOW_EOPNOTSUPP NOFOLLOW_REGULAR_COMMITS NONOWNER_EPERM DIRECTORY_STICKY_BITS"),
    "sync_file_range": ("raw-differential", "pass", "FD_BEFORE_FLAGS OPATH_FD_EBADF FLAGS_BEFORE_TYPE OFFSET_SIGN_BEFORE_TYPE LENGTH_SIGN_BEFORE_TYPE WRAPPING_END_EINVAL FIFO_ESPIPE SOCKET_ESPIPE REGULAR_RANGE_OK ALL_FLAGS_ACCEPTED EOF_FROM_LLONG_MAX_OK READONLY_DESCRIPTION_OK DIRECTORY_OK HINT_PRESERVES_CONTENT"),
    "cachestat": ("raw-differential", "pass", "FD_BEFORE_RANGE_COPY OPATH_FD_EBADF RANGE_COPY_BEFORE_FLAGS FLAGS_EINVAL FLAGS_BEFORE_COPYOUT COPYOUT_EFAULT ADMISSION_BEFORE_FLAGS ANONYMOUS_PIPE_READ_END_OK SOCKET_QUERY_OK DIRECTORY_QUERY_OK EMPTY_RANGE_COUNTERS_ZERO COUNTER_INVARIANTS UNALIGNED_AND_40_BYTE_COPYOUT HUGETLBFS_EOPNOTSUPP"),
    "sync": ("raw-differential", "pass", "IGNORES_ARGUMENTS DATA_VISIBLE_AFTER_SYNC"),
    "inotify_init": ("raw-differential", "pass", "INIT_FD_SHAPE INIT_IGNORES_EXTRA_ARGS INIT_INSTANCE_INDEPENDENT"),
    "inotify_init1": ("raw-differential", "pass", "FLAG_MASK_EINVAL FLAG_STATUS_REPORTED EMPTY_QUEUE_EAGAIN NONBLOCK_CLOEXEC_COMBINED"),
    "inotify_rm_watch": ("raw-differential", "pass", "FD_BEFORE_WD UNKNOWN_WD_EINVAL INSTANCE_LOCAL_WD REMOVE_QUEUES_IGNORED"),
    "signalfd": ("raw-differential", "pass", "SIZEMASK_EINVAL COPY_BEFORE_FD FD_ADMISSION CREATE_STATUS_AND_RECORD_SIZE UPDATE_RETURNS_FD MASK_SELECTS_SIGNAL PENDING_RECORD_DELIVERED"),
    "io_pgetevents": ("raw-differential", "pass", "TIMEOUT_COPY_BEFORE_SIGSET SIGSET_COPY_ORDER NULL_SIGMASK_ANY_SIZE NR_AND_CONTEXT_EINVAL MASK_RESTORED EVENT_DELIVERED_WITH_SIGSET"),
    "rseq": ("raw-differential", "pass", "FLAG_ADMISSION LENGTH_AND_ALIGNMENT REGISTRATION_INITIALIZES_AREA REREGISTER_VERDICTS UNREGISTER_MATCHES_REGISTRATION UNREGISTER_RESETS_FIELDS UNREGISTER_NOT_REGISTERED FORK_INHERITS_REGISTRATION CLONE_VM_CLEARS_REGISTRATION"),
})
...
PROGRAM_CASES = {
    ...
    "fs-boundary": ("flock", "utimensat", "fallocate", "readahead", "inotify_add_watch", "signalfd4", "timerfd_settime", "utime", "utimes", "futimesat", "fchmodat2", "sync_file_range", "cachestat", "sync", "inotify_init", "inotify_init1", "inotify_rm_watch", "signalfd"),
...
SYSCALL_CASES = {
    ...
    253: ("fs-boundary", "inotify_init"), 294: ("fs-boundary", "inotify_init1"),
    255: ("fs-boundary", "inotify_rm_watch"), 282: ("fs-boundary", "signalfd"),
    132: ("fs-boundary", "utime"), 235: ("fs-boundary", "utimes"),
    261: ("fs-boundary", "futimesat"), 452: ("fs-boundary", "fchmodat2"),
