...
PROGRAM_CASES = {
    ...
    "fs-abi": ("getcwd", "fcntl", "syslog", "reboot", "ioctl", "mount", "umount2", "pipe2", "syncfs", "preadv2", "pwritev2", "fallocate-mode", "tee", "vmsplice", "readahead-types", "pidfd-send-signal", "ustat", "sysinfo", "uname"),
